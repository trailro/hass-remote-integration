...
# HRI_VERSION=0.25.2      # optional: pin a release (default: latest)
...
(`v0.25.2 · 1a2b3c4`), linking to that release. When GitHub has newer releases
...
| `HRI_VERSION` | `latest` | Image tag Compose pulls, for example `0.25.2` |
