...
# HRI_VERSION=0.21.1      # optional: pin a release (default: latest)
...
from (`v0.21.1 · 1a2b3c4`), linking to that release. When GitHub has newer
...
| `HRI_VERSION` | `latest` | Image tag Compose pulls, for example `0.21.1` |
